...
def search_netcraft(self, target):
    ...
    try:
        res = requests.get("https://searchdns.netcraft.com/", headers=headers, params=params)
        scraped = res.text
        trimmed = scraped[scraped.find('<div class="blogtitle">'):scraped.rfind('<div id="copyright">')]
        subdomain_finder = re.compile('<a href="http://toolbar.netcraft.com/site_report\?url=(.*)">')
        ...
        self.errors.append("Error in Netcraft")
